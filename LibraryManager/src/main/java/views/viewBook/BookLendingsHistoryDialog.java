 ...
 * @author Femen
 */
public class BookLendingsHistoryDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Book's lending history");
        ...
        historyTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User name", "User id", "Lending date", "Return date"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookLendingsHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BookLendingsHistoryDialog dialog = new BookLendingsHistoryDialog(new javax.swing.JFrame(), true);
