 ...
 * @author Femen
 */
public class BookLendingDatesCellRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        BooksLendingHistoryTableModel tableModel = (BooksLendingHistoryTableModel) table.getModel(); // Get the lending
